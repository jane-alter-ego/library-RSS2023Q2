...
console.log(`Library#3 Самооценка 173/200\n
Ограниченная карусель в блоке About - нет анимации перелистывания: минус 9 баллов за пункт, все остальные есть\n
Слайдер в блоке Favorites - нет анимации затухания: минус 11 баллов за пункт, панель sticky и появление-исчезновение книжек есть\n
Модальное окно Register закрывается только по крестику, минус 1 балл\n
Модальное окно Login закрывается только по крестику, минус 1 балл\n
При наведении курсором на иконку пользователя не отображаться полное имя пользователя, минус 2 балла\n
Модальное окно Profile закрывается только по крестику, минус 1 балл\n
Горизонтального скролла у списка книг нет специально, минус 1 балл\n
Модальное окно BUY A LIBRARY CARD закрывается только по крестику, минус 1 балл\n`)
