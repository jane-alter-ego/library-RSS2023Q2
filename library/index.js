...
два инпута\n
\n
Вёрстка соответствует макету 52/54\n
\n
блок header 8/8:\n
...
Обратите внимание, что кнопки хоть и имеют вид круга, но интерактивная область должна быть размером +5px в каждую сторону. Т.е. это будут прозрачные элементы размерами 26x26, внутри которых будут располагаться непосредственно кнопки 16x16. Не поняла, как надо выполнить условие\n
\n
